...
local songData = { -- The main table that contains the songs you want credits on
    ...
    ['Respite'] = { -- This name NEEDS to be the name in the direct JSON/chart (e.g: dad-battle).
        ["songName"] = "Respite", -- The display name of the song.
        ...
        -- IF YOU WANT ME TO MAKE IT TO BE IN ORDER, LEAVE A COMMENT ON THE GAMEBANANA PAGE AND I'LL DO IT!
            ["Composer"] = "Tuff",
            ["Artists"] = "RonaTheRTD, Benjamin the Raccoon",
            ["Charter"] = "TheWildBlueCat",
        },
    },
    ...
    ['Great Debate'] = { 
        ...
        ["credits"] = { 
            ...
            ["Artists"] = "RonaTheRTD, Benjamin the Raccoon",
            ["Charter"] = "???",
            ["Special Guest"] = "Sonic the Hedgehog",
        },
    },


    ['Respite (UTAU)'] = { 
        ["songName"] = "Respite (UTAU)", 
        ["length"] = 4, 
        ["boxColor"] = "#000000", 
        ["textColor"] = "#FFFFFF", 
        ["credits"] = { 
            ["Composer"] = "Tuff",
            ["UTAU Cover"] = "RonaTheRTD",
            ["Artists"] = "RonaTheRTD, Benjamin the Raccoon",
            ["Charter"] = "TheWildBlueCat",
        },
    },
