...
class Achievements {
	public static function init()
	{
		...
		createAchievement('weekR_nomiss',			{name: "BF Has Passed Act R", description: "Beat Roman's Week without Missing."});
		...
		createAchievement('oversinging', 			{name: "Oversinging Much...?", description: "You really like holding down buttons, huh?"});
		createAchievement('hype',					{name: "Hyperactive", description: "I guess you're not one to stay in one spot."});
		createAchievement('two_keys',				{name: "Just the Two of Us", description: "Pick two keys and stick with them for the whole song."});
		createAchievement('toastie',				{name: "Toaster Gamer", description: "You know what they say, be a toaster gamer!"});
